...
//   const form = useForm<KycDeclineFormData>({
//     resolver: zodResolver(kycDeclineSchema),
//     defaultValues: {
//       status: "declined",
//       what_failed: "",
//       admin_comment: "",
...
// //   const { register, handleSubmit } = useForm<KycDeclineFormData>({
// //     resolver: zodResolver(kycDeclineSchema),
// //     defaultValues: {
// //       status: "declined",
// //       what_failed: "",
...
//   const onFormSubmit = (data: KycDeclineFormData) => {
//     const stringifyReason = selectedReasons.join(",")
//     const formData: KycDeclineFormData = {
//         status: "declined",
//         what_failed: stringifyReason,
//         admin_comment: data.admin_comment
//     }
//     const validate = kycDeclineSchema.safeParse(formData)
//     if(!validate.success){
//         console.error(validate.error)
//         return
//     }
//     console.log("formData:", validate.data)
...
//         <form onSubmit={form.handleSubmit(onFormSubmit)} className="px-4 space-y-6">
//           {/* Select reasons */}
//           <div className="space-y-2">
//             <Label className="text-sm font-medium text-gray-700">
//               Select Issues
...
//                         <span
//                           key={reason}
//                           className="bg-megagreen/10 text-megagreen text-sm px-2 py-1 rounded-full"
//                         >
//                           {reason}
//                         </span>
//                       ))}
...
//                     checked={selectedReasons.includes(reason)}
//                     onCheckedChange={() => toggleReason(reason)}
//                     // 👇 Prevent auto-close on each click
//                     onSelect={(e) => e.preventDefault()}
//                   >
//                     {reason}
//                   </DropdownMenuCheckboxItem>
...
//             className="w-full bg-megagreen hover:bg-megagreen/90 text-white font-semibold py-2 px-4 rounded-md"
//           >
//             Decline KYC and Send Email
//           </Button>
//           {form.formState.errors.admin_comment}
//         </form>
//       </DialogContent>
//     </Dialog>
//   );
